...
describe('Integration Test', () => {
    ...
    let createAlphachain = (name, host, port, peers) => {
    ...
    step('start server', () => {
        return createAlphachain(name1, 'localhost', 3001, [])
            .then((httpServer) => {
    ...
    step('start server 2', () => {
        return createAlphachain(name2, 'localhost', 3002, [{ url: 'http://localhost:3001' }])
            .then((httpServer) => {
